// ==UserScript==
// @name         IMX.TO Direktlink auf GirlsReleased
...
(function() {
    ...
    auswahl.innerHTML = '<form id="imxtoauswahl"><label for="imxtoselect">IMX.TO-Server:</label><select name="imxtoselect" id="imxtoselect" size="1"><option value="i" selected>i</option><option value="i001">i001</option><option value="i002">i002</option><option value="i003">i003</option></select>.imx.to <button id="imxtoselectbtn">Auswahl</button></form>';
